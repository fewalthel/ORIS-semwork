...
Есть личный кабинет с юзернеймом и статистикой по заданным вопросам и данным ответам. <br>
...
У каждого пользователя уникальный username и email. Username и пароль можно изменить в разделе «настройки». Email изменить невозможно, он прикрепляется за пользователем. <br>
