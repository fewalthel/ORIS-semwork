...
public class RegisterService {
    ...
    public RegisterService(UserDAO userDAO, FileService fileService) {
    ...
    public void save(User account) throws SQLException, IOException {
        PasswordEncoder passwordEncoder = new BCryptPasswordEncoder();
        String password = passwordEncoder.encode(account.getPassword());
        account.setPassword(password);

        userDAO.saveToDB(account);
        User user = userDAO.getByUsername(account.getUsername());
        fileService.setDefaultAvatar(user);
    }
