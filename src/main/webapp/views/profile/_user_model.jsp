<section class="user-card" style="height: 24vw;">
    ...
    <p class="user_questions" &lt;%&ndash;style="font-size: 1.5vw; height: 3vw; padding-bottom: 1vw; padding-left: 1vw;"&ndash;%&gt;>
        questions asked: <%=QuestionDAO.getAllByAuthor(userList).size()%></p>
    <p class="user_answers" &lt;%&ndash;style="font-size: 1.5vw; height: 3vw; padding-bottom: 1vw; padding-left: 1vw;"&ndash;%&gt;>
