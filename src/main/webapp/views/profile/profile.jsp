...
<div id="container-for-content">
    <section id="about-user" class="statistics-card" style="display: flex; justify-content: space-between">
        <img src="${pageContext.request.contextPath}/${path_to_avatar}" alt="avatar" style="width: 15vw; border-radius: 50%; /*box-shadow: 0 0 #7dffd3; */filter: drop-shadow(0 0 15px #7dffd3); margin-left: 2vw;">
