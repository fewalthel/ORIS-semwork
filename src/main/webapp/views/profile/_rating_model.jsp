...
<div class="container-for-marks">
    ...
    <% if (RatingDAO.getByIdOfUser(user, answer) == null) {%>
        ...
        <button type="submit" name="rating" value="false"><img class="mark-img" style="width: 35px;" src="pics/thumbs-down.svg" alt="thumbs down"></button>
    ...
    <%} if (RatingDAO.getByIdOfUser(user, answer) != null && !RatingDAO.getByIdOfUser(user, answer).getLiked()) {%>
        <button type="submit" name="rating" value="true"><img class="mark-img" style="width: 35px;" src="pics/thumbs-up.svg" alt="thumbs up"></button>
        <button type="submit" name="rating" value="null"><img class="mark-img" style="width: 35px;" src="pics/thumbs-down-fill.svg" alt="thumbs down"></button>
    <%}%>
    </form>
</div>