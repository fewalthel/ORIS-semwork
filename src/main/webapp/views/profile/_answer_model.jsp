<section class="answer-card">
    ...
    <div class="container-for-answer-info">
        ...
        <form action="favorites_answers" method="POST" class="favourite-form">
            ...
            <c:forEach items="${favorites_answers}" var="fav_answer">
                <c:if test="${answer.getId() == fav_answer.getId()}">
                    ...
                    <button style="background-color: var(--dark-text-color); color: white;" type="submit" class="button fav-button">In your favorites</button>
                </c:if>
            </c:forEach>
            <c:if test="${!inFavorites}">
                <button style="background-color: var(--mint-color);" type="submit" class="button fav-button">Add to favorites</button>
            </c:if>
        </form>
    </div>
